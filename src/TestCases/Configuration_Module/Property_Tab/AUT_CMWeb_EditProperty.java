package TestCases.Configuration_Module.Property_Tab;
...
import FunctionLibraries.ManagingPropertyFunction;
...
public class AUT_CMWeb_EditProperty extends Report {
	...
	public void main() throws Exception {
		...
		// Edit Property - unassign site
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingSiteFunction.GoToAccount(iTestCaseRow);
		ManagingPropertyFunction.GoToPropertyTab(iTestCaseRow);
		ManagingPropertyFunction.SearchProperty(iTestCaseRow);
		ManagingPropertyFunction.EditProperty(iTestCaseRow);
		ManagingPropertyFunction.SaveProperty(iTestCaseRow);
