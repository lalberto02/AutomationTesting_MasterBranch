...
public class AUT_CMWeb_Menu_DeleteKeyword extends Report {
	...
	public void beforeMethod() throws Exception {
		...
		ExcelUtils.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "Keyword");
	...
	public void main() throws Exception {
		...
		// Delete keyword - select specific keyword
		...
		ManagingKeywordFunction.DeleteKeyword(iTestCaseRow);
