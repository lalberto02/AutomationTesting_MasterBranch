package TestCases.Configuration_Module.AutoNumbering_Tab;
...
public class AUT_CMWeb_ActivateMerchAutoNum extends Report {
	...
	public void main() throws Exception {
		...
		// Activate Merchandise Auto Numbering
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingAutoNumberingFunction.GoToToolsTab(iTestCaseRow);
		ManagingAutoNumberingFunction.GoToAutoNumTab(iTestCaseRow);
		ManagingAutoNumberingFunction.ActivateMerchandise(iTestCaseRow);
		ManagingAutoNumberingFunction.SaveAutoNumbering(iTestCaseRow);
