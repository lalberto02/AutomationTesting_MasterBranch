package TestCases.Configuration_Module.PrintProfile_Tab;
...
import FunctionLibraries.ManagingPrintProfile;
import FunctionLibraries.ManagingRolesFunction;
import FunctionLibraries.MenuPlanFunction;
...
public class AUT_CMWeb_CreatePrintProfile extends Report {
	...
	public void main() throws Exception {
		...
		ManagingPrintProfile.GoToToolsTab(iTestCaseRow);
		ManagingPrintProfile.GoToPrintProfileTab(iTestCaseRow);
		ManagingPrintProfile.CreatePrintProfile(iTestCaseRow);
		ManagingPrintProfile.SavePrintProfile(iTestCaseRow);
		ManagingPrintProfile.SearchPrintProfile(iTestCaseRow);
