package TestCases.Configuration_Module.Translation_Tab;
...
public class AUT_CMWeb_ManagingTranslation extends Report {
	...
	public void create() throws Exception {
		String sTestCaseName1 = "AUT_CMWeb_CreateTranslation";
		...
		ManagingTranslationFunction.CreateTranslation(iTestCaseRow);
		ManagingTranslationFunction.SaveTranslation(iTestCaseRow);
	...
	public void search() throws Exception {
		String sTestCaseName2 = "AUT_CMWeb_SearchTranslation";
	...
	public void edit() throws Exception {
		String sTestCaseName3 = "AUT_CMWeb_EditTranslation";
		...
		// Edit translation name
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingTranslationFunction.GoToTranslationTab(iTestCaseRow);
		ManagingTranslationFunction.SearchTranslation(iTestCaseRow);
		ManagingTranslationFunction.EditTranslation(iTestCaseRow);
		ManagingTranslationFunction.SaveTranslation(iTestCaseRow);
