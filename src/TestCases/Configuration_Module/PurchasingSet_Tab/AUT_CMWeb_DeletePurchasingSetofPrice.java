...
public class AUT_CMWeb_DeletePurchasingSetofPrice extends Report {
	...
	public void main() throws Exception {
		...
		// delete purchasing set of price
		...
		ManagingSetofPriceFunction.DeletePurchasingSet(iTestCaseRow);
