package TestCases.Configuration_Module.MerchandiseSupplier_Tab;
...
import FunctionLibraries.ManagingMerchSupplierFunction;
...
public class AUT_CMWeb_EditMerchSupplier extends Report {
	...
	public void main() throws Exception {
		...
		// Edit merchandise Supplier - change sharing
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToMerchandiseTab(iTestCaseRow);
		ManagingMerchSupplierFunction.GoToSupplierTab(iTestCaseRow);
		ManagingMerchSupplierFunction.SearchSupplier(iTestCaseRow);
		ManagingMerchSupplierFunction.EditSupplier(iTestCaseRow);
		ManagingMerchSupplierFunction.SaveSupplier(iTestCaseRow);
