package TestCases.Configuration_Module.Breadcrumbs_Tab;
...
import FunctionLibraries.ManagingAutoNumberingFunction;
import FunctionLibraries.ManagingBreadcrumbsFunction;
...
public class AUT_CMWeb_DeleteBreadcrumbs extends Report {
	...
	public void main() throws Exception {
		...
		ManagingAutoNumberingFunction.GoToToolsTab(iTestCaseRow);
		ManagingBreadcrumbsFunction.GoToBreadcrumbsTab(iTestCaseRow);
		ManagingBreadcrumbsFunction.SearchBreadcrumbs(iTestCaseRow);
		ManagingBreadcrumbsFunction.DeleteBreadcrumbs(iTestCaseRow);
