...
public class AUT_CMWeb_EditRecipeSource extends Report {
	...
	public void main() throws Exception {
		...
		// Edit recipe source - change sharing
		...
		ManagingSourceFunction.EditSource(iTestCaseRow);
		ManagingSourceFunction.SaveSource(iTestCaseRow);
