...
public class AUT_CMWeb_EditRecipePublication extends Report {
	...
	public void main() throws Exception {
		...
		// edit recipe publication - change publication name
		...
		ManagingPublicationFunction.EditPublication(iTestCaseRow);
		ManagingPublicationFunction.SavePublication(iTestCaseRow);
