package TestCases.Configuration_Module.RecipeCookbook_Tab;
...
import FunctionLibraries.ManagingRecipeCookbookFunction;
...
public class AUT_CMWeb_EditRecipeCookbook extends Report {
	...
	public void main() throws Exception {
		...
		// Edit recipe cookbook - change cookbookname
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingRecipeCookbookFunction.GoToCookbookTab(iTestCaseRow);
		ManagingRecipeCookbookFunction.SearchCookbook(iTestCaseRow);
		ManagingRecipeCookbookFunction.EditCookbook(iTestCaseRow);
		ManagingRecipeCookbookFunction.SaveCookbook(iTestCaseRow);
