package TestCases.Configuration_Module.RecipeTime_Tab;
...
import FunctionLibraries.ManagingRecipeTimeFunction;
...
public class AUT_CMWeb_EditRecipeTime extends Report {
	...
	public void main() throws Exception {
		...
		// edit Recipe Time -  change French translation
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingRecipeTimeFunction.GoToRecipeTimeTab(iTestCaseRow);
		ManagingRecipeTimeFunction.SearchRecipeTime(iTestCaseRow);
		ManagingRecipeTimeFunction.EditRecipeTime(iTestCaseRow);
		ManagingRecipeTimeFunction.SaveRecipeTime(iTestCaseRow);
