package TestCases.Configuration_Module.Kiosk_Tab;
...
import FunctionLibraries.ManagingKioskFunction;
...
public class AUT_CMWeb_EditKiosk extends Report {
	...
	public void main() throws Exception {
		...
		// Edit kiosk - change sharing
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingKioskFunction.GoToKioskTab(iTestCaseRow);
		ManagingKioskFunction.SearchKiosk(iTestCaseRow);
		ManagingKioskFunction.EditKiosk(iTestCaseRow);
		ManagingKioskFunction.SaveKiosk(iTestCaseRow);
