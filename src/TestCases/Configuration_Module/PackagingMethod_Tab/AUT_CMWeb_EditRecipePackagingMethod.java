package TestCases.Configuration_Module.PackagingMethod_Tab;
...
import FunctionLibraries.ManagingPackagingFunction;
...
public class AUT_CMWeb_EditRecipePackagingMethod extends Report {
	...
	public void main() throws Exception {
		...
		// Edit packaging method -  change french translation
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingPackagingFunction.GoToPackagingMethod(iTestCaseRow);
		ManagingPackagingFunction.SearchPackagingMethod(iTestCaseRow);
		ManagingPackagingFunction.EditPackagingNotes(iTestCaseRow);
		ManagingPackagingFunction.SavePackagingMethod(iTestCaseRow);
