package TestCases.Configuration_Module.ProductionLoc_Tab;
...
import FunctionLibraries.ManagingProductionLocFunction;
...
public class AUT_CMWeb_EditProductionLocation extends Report {
	...
	public void main() throws Exception {
		...
		// edit production location - change sharing
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingProductionLocFunction.GoToProductionLocTab(iTestCaseRow);
		ManagingProductionLocFunction.SearchProductionLoc(iTestCaseRow);
		ManagingProductionLocFunction.EditProductionLoc(iTestCaseRow);
		ManagingProductionLocFunction.SaveProductionLoc(iTestCaseRow);
