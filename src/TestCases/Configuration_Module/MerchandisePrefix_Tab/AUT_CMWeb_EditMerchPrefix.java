package TestCases.Configuration_Module.MerchandisePrefix_Tab;
...
import FunctionLibraries.ManagingMerchPrefixFunction;
...
public class AUT_CMWeb_EditMerchPrefix extends Report {
	...
	public void main() throws Exception {
		...
		// Edit merchandise prefix - change sharing
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToMerchandiseTab(iTestCaseRow);
		ManagingMerchPrefixFunction.GoToPrefixTab(iTestCaseRow);
		ManagingMerchPrefixFunction.SearchPrefix(iTestCaseRow);
		ManagingMerchPrefixFunction.EditPrefix(iTestCaseRow);
		ManagingMerchPrefixFunction.SavePrefix(iTestCaseRow);
