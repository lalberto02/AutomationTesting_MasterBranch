package TestCases.Configuration_Module.RecipeCertification_Tab;
...
import FunctionLibraries.ManagingRecipeCertFunction;
...
public class AUT_CMWeb_EditRecipeRecipeCertification extends Report {
	...
	public void main() throws Exception {
		...
		// Edit Recipe Certification - change french translation
		ManagingRolesFunction.GoToConfiguration(iTestCaseRow);
		ManagingKeywordFunction.GoToRecipeTab(iTestCaseRow);
		ManagingRecipeCertFunction.GoToRecipeCertification(iTestCaseRow);
		ManagingRecipeCertFunction.SearchRecipeCertification(iTestCaseRow);
		ManagingRecipeCertFunction.EditRecipeCertifcation(iTestCaseRow);
		ManagingRecipeCertFunction.SaveRecipeCertification(iTestCaseRow);
