...
public class AUT_CMWeb_CreateNewRecipe extends Report {
	...
	public void main() throws Exception {
		...
		RecipeFunction.SearchCreatedRecipe(iTestCaseRow);
	...
	public void afterMethod(ITestResult result) throws IOException {
		...
		// Capture screenshot
		 if (result.getStatus()== ITestResult.FAILURE) {
			  logger.fail("Test Failed", MediaEntityBuilder.createScreenCaptureFromPath(Utils.takeScreenshot(driver)).build());
		 } else if (result.getStatus()== ITestResult.SUCCESS) {
			 logger.pass("Test Passed", MediaEntityBuilder.createScreenCaptureFromPath(Utils.takeScreenshot(driver)).build());
		 }
