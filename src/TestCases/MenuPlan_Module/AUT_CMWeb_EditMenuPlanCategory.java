package TestCases.MenuPlan_Module;
...
public class AUT_CMWeb_EditMenuPlanCategory extends Report{
	...
	@Test
	  public void main() throws Exception {
		...
		// edit category - add french translation
		MenuPlanFunction.GoToMenuPlan(iTestCaseRow);
		MenuPlanFunction.GoToConfiguration(iTestCaseRow);
		MenuPlanFunction.GoToMenuPlanCategoryTab(iTestCaseRow);
		MenuPlanFunction.SearchConfigCategory(iTestCaseRow);
		MenuPlanFunction.EditCategory(iTestCaseRow);
