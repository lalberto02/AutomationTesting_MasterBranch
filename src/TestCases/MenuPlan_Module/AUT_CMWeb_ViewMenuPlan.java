...
public class AUT_CMWeb_ViewMenuPlan extends Report {
	...
	public void beforeMethod() throws Exception {
		...
		// http://www.toolsqa.com/data-driven-testing-excel-poi/
		 ExcelUtils.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "MenuPlan");
	...
	public void main() throws Exception {
		...
		// View menu plan history
		MenuPlanFunction.GoToMenuPlan(iTestCaseRow);
		MenuPlanFunction.ViewRecentMenu(iTestCaseRow);
