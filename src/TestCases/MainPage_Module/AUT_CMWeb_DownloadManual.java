package TestCases.MainPage_Module;
...
import FunctionLibraries.MainPageFunction;
...
public class AUT_CMWeb_DownloadManual extends Report {
	...
	public void beforeMethod() throws Exception {
		...
		// http://www.toolsqa.com/data-driven-testing-excel-poi/
		 ExcelUtils.setExcelFile(Constant.Path_TestData + Constant.File_TestData, "MainPage");
	...
	public void main() throws Exception {
		...
		// Download Manual based on prefer language
		MainPageFunction.GoToViewHelpSupport(iTestCaseRow);
		MainPageFunction.DownloadManual(iTestCaseRow);
